...
/* Smarty version 4.5.5, created on 2025-11-12 16:58:54
  from '/var/www/html/layouts/v7/modules/Calendar/uitypes/StatusPickListFieldSearchView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_69143e3e0cf005_60337965',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'b92d5c9c7a56598986769b6509801359a188fc7d' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Calendar/uitypes/StatusPickListFieldSearchView.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_69143e3e0cf005_60337965 (Smarty_Internal_Template $_smarty_tpl) {
...
$_tmp_array[$_smarty_tpl->tpl_vars['PICKLIST_KEY']->value] = ((('(').(vtranslate('SINGLE_Calendar',"Calendar"))).(')')).($_smarty_tpl->tpl_vars['PICKLIST_LABEL']->value);
...
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['EVENT_STAUTS_PICKLIST_VALUES']->value, 'PICKLIST_LABEL', false, 'PICKLIST_KEY');
$_smarty_tpl->tpl_vars['PICKLIST_LABEL']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['PICKLIST_KEY']->value => $_smarty_tpl->tpl_vars['PICKLIST_LABEL']->value) {
$_smarty_tpl->tpl_vars['PICKLIST_LABEL']->do_else = false;
if ($_smarty_tpl->tpl_vars['PICKLIST_LABEL']->value == vtranslate('Planned',"Calendar")) {
$_tmp_array = isset($_smarty_tpl->tpl_vars['EVENT_STAUTS_PICKLIST_VALUES']) ? $_smarty_tpl->tpl_vars['EVENT_STAUTS_PICKLIST_VALUES']->value : array();
if (!(is_array($_tmp_array) || $_tmp_array instanceof ArrayAccess)) {
settype($_tmp_array, 'array');
}
$_tmp_array[$_smarty_tpl->tpl_vars['PICKLIST_KEY']->value] = ((((('(').(vtranslate('SINGLE_Calendar',"Calendar"))).('/')).(vtranslate('SINGLE_Events',"Calendar"))).(')')).($_smarty_tpl->tpl_vars['PICKLIST_LABEL']->value);
$_smarty_tpl->_assignInScope('EVENT_STAUTS_PICKLIST_VALUES', $_tmp_array);
} else {
$_tmp_array = isset($_smarty_tpl->tpl_vars['EVENT_STAUTS_PICKLIST_VALUES']) ? $_smarty_tpl->tpl_vars['EVENT_STAUTS_PICKLIST_VALUES']->value : array();
if (!(is_array($_tmp_array) || $_tmp_array instanceof ArrayAccess)) {
settype($_tmp_array, 'array');
}
$_tmp_array[$_smarty_tpl->tpl_vars['PICKLIST_KEY']->value] = ((('(').(vtranslate('SINGLE_Events',"Calendar"))).(')')).($_smarty_tpl->tpl_vars['PICKLIST_LABEL']->value);
$_smarty_tpl->_assignInScope('EVENT_STAUTS_PICKLIST_VALUES', $_tmp_array);
}
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
