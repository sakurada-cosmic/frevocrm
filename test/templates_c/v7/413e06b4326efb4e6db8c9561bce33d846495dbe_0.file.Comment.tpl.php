<?php
/* Smarty version 4.5.5, created on 2025-11-17 14:13:09
  from '/var/www/html/layouts/v7/modules/Vtiger/Comment.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_691aaee557e124_19295183',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '413e06b4326efb4e6db8c9561bce33d846495dbe' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Vtiger/Comment.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_691aaee557e124_19295183 (Smarty_Internal_Template $_smarty_tpl) {
...
"><?php $_smarty_tpl->_assignInScope('CREATOR_NAME', $_smarty_tpl->tpl_vars['COMMENT']->value->getCommentedByName());?><div class="col-lg-2 recordImage commentInfoHeader" style ="width:50px; height:50px; font-size: 30px;" data-commentid="<?php echo $_smarty_tpl->tpl_vars['COMMENT']->value->getId();?>
" data-parentcommentid="<?php echo $_smarty_tpl->tpl_vars['COMMENT']->value->get('parent_comments');?>
" data-relatedto = "<?php echo $_smarty_tpl->tpl_vars['COMMENT']->value->get('related_to');?>
...
" width="100%" height="100%" align="left"><?php } else { ?><div class="name"><span><strong> <?php echo substr((string) $_smarty_tpl->tpl_vars['CREATOR_NAME']->value, (int) 0, (int) 1);?>
...
if ($_smarty_tpl->tpl_vars['CURRENTUSER']->value->getId() == $_smarty_tpl->tpl_vars['COMMENT']->value->get('userid') || $_smarty_tpl->tpl_vars['CURRENTUSER']->value->isAdminUser()) {?>&nbsp;&nbsp;&nbsp;<a href="javascript:void(0);" class="cursorPointer deleteComment feedback" style="color: blue;"><?php echo vtranslate('LBL_DELETE',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</a><?php }
}
...
"><a href="javascript:void(0)" class="cursorPointer viewThread" style="color: blue;"><?php echo vtranslate('LBL_HIDDEN',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
&nbsp;</a></span><span class="hideThreadBlock" data-child-comments-count="<?php echo $_smarty_tpl->tpl_vars['CHILD_COMMENTS_COUNT']->value;?>
" style="display:none;"><a href="javascript:void(0)" class="cursorPointer hideThread" style="color: blue;"><?php echo vtranslate('LBL_DISPLAY',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
...
if ($_smarty_tpl->tpl_vars['COMMENTS_MODULE_MODEL']->value->isPermitted('EditView')) {?>&nbsp;&nbsp;&nbsp;<?php }?><span class="viewThreadBlock" data-child-comments-count="<?php echo $_smarty_tpl->tpl_vars['CHILD_COMMENTS_COUNT']->value;?>
" style="display:none;"><a href="javascript:void(0)" class="cursorPointer viewThread" style="color: blue;"><?php echo vtranslate('LBL_HIDDEN',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
&nbsp;</a></span><span class="hideThreadBlock" data-child-comments-count="<?php echo $_smarty_tpl->tpl_vars['CHILD_COMMENTS_COUNT']->value;?>
"><a href="javascript:void(0)" class="cursorPointer hideThread" style="color: blue;"><?php echo vtranslate('LBL_DISPLAY',$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
