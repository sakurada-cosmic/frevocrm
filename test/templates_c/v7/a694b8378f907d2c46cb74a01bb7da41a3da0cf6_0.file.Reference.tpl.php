...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d64810fbec9_93633773',
...
function content_690d64810fbec9_93633773 (Smarty_Internal_Template $_smarty_tpl) {
...
_historyback_restore" data-fieldtype="reference" style="display:none"></input><input name="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName();?>
_historyback_restore_name" data-fieldtype="reference" style="display:none"></input><input name="<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldName();?>
...
'<?php }?>/><a href="#" class="clearReferenceSelection <?php if (empty($_smarty_tpl->tpl_vars['FIELD_VALUE']->value)) {?>hide<?php }?>"> x </a><span class="input-group-addon relatedPopup cursorPointer" title="<?php echo vtranslate('LBL_SELECT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
