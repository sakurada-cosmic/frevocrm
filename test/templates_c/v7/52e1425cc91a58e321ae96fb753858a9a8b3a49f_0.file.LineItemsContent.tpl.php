<?php
/* Smarty version 4.5.5, created on 2025-11-07 15:07:54
  from '/var/www/html/layouts/v7/modules/Inventory/partials/LineItemsContent.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d8cbaa18155_00162221',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '52e1425cc91a58e321ae96fb753858a9a8b3a49f' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Inventory/partials/LineItemsContent.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_690d8cbaa18155_00162221 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_assignInScope('usageunit', ("usageunit").($_smarty_tpl->tpl_vars['row_no']->value));
$_smarty_tpl->_assignInScope('reducedtaxrate', ("reducedtaxrate").($_smarty_tpl->tpl_vars['row_no']->value));
...
ob_start();
if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['purchaseCost']->value]) && !empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value])) {
echo (string)(((float)$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['purchaseCost']->value])/((float)$_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value]*$_prefixVariable7));
} else {
echo "0";
}
...
" class="lineItemCommentBox" style="width: 400px; max-width: 650px; height:150px;"><?php echo decode_html($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['comment']->value]);?>
</textarea></div><?php }
}?></td><?php }?><td><input id="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['qty']->value;?>
" type="text" class="qty smallInputBox inputElement"data-rule-required=true data-rule-positive=false data-rule-greater_than_zero=true value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value])) {
...
" type="hidden" value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['purchaseCost']->value]) && !empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value])) {
...
echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['margin']->value];
} else { ?>0<?php }?></span><?php }?><br><br><span><?php echo vtranslate('Usage Unit',"Products");?>
:</span><input id="<?php echo $_smarty_tpl->tpl_vars['usageunit']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['usageunit']->value;?>
" value="<?php if (!empty($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['usageunit']->value])) {
echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['usageunit']->value];
}?>" type="text" class="usageunit smallInputBox inputElement" readonly style="border:hidden"/><?php if ($_smarty_tpl->tpl_vars['MODULE']->value != 'PurchaseOrder') {?><br><span class="stockAlert redColor <?php if ($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qty']->value] <= $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qtyInStock']->value] || $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['qtyInStock']->value] === false) {?>hide<?php }?>" ><?php echo vtranslate('LBL_STOCK_NOT_ENOUGH',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
} else { ?>0<?php }?>" type="text"data-rule-required=true data-rule-positive=false class="listPrice smallInputBox inputElement" data-is-price-changed="<?php if ($_smarty_tpl->tpl_vars['RECORD_ID']->value && $_smarty_tpl->tpl_vars['row_no']->value != 0) {?>true<?php } else { ?>false<?php }?>" list-info='<?php if ((isset($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['listPrice']->value]))) {
...
</span></p><?php if (php7_count($_smarty_tpl->tpl_vars['data']->value['taxes']) > 0) {?><div class="individualTaxDiv"><!-- we will form the table with all taxes --><table width="100%" border="0" cellpadding="5" cellspacing="0" class="table table-nobordered popupTable" id="tax_table<?php echo $_smarty_tpl->tpl_vars['row_no']->value;?>
"><?php
...
} else { ?>0<?php }?></span><br><br><label style="font-weight:normal" for='<?php echo $_smarty_tpl->tpl_vars['reducedtaxrate']->value;?>
'><input type="checkbox" class="reducedtaxrate" id="<?php echo $_smarty_tpl->tpl_vars['reducedtaxrate']->value;?>
" name="<?php echo $_smarty_tpl->tpl_vars['reducedtaxrate']->value;?>
" value="<?php echo $_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['reducedtaxrate']->value];?>
" <?php if (($_smarty_tpl->tpl_vars['data']->value[$_smarty_tpl->tpl_vars['reducedtaxrate']->value]) == '1') {?>checked<?php }?> style="border:hidden"/>:<?php echo vtranslate('Reduced TaxRate',"Products");?>
</label></td><?php }
}
