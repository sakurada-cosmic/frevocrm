<?php
/* Smarty version 4.5.5, created on 2025-11-07 13:07:11
  from '/var/www/html/layouts/v7/modules/CustomView/EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d706f4558a4_25022134',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '4f219fcc78ad5d568bd19a0ce096f58f2ca100c9' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/CustomView/EditView.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_690d706f4558a4_25022134 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/html/vendor/smarty/smarty/libs/plugins/modifier.replace.php','function'=>'smarty_modifier_replace',),));
?>

<?php $_smarty_tpl->_assignInScope('SELECTED_FIELDS', $_smarty_tpl->tpl_vars['CUSTOMVIEW_MODEL']->value->getSelectedFields());
...
" id="viewname" name="viewname" value="<?php echo vtranslate($_smarty_tpl->tpl_vars['CUSTOMVIEW_MODEL']->value->get('viewname'),$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataType() == 'blank') {
continue 1;
}
...
"<?php if (in_array(decode_html($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getCustomViewColumnName()),$_smarty_tpl->tpl_vars['SELECTED_FIELDS']->value)) {?>selected<?php } elseif ($_smarty_tpl->tpl_vars['MODE_DUPLICATE']->value == false) {?>														<?php if ((!$_smarty_tpl->tpl_vars['RECORD_ID']->value) && ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isSummaryField() || $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isHeaderField()) && ($_smarty_tpl->tpl_vars['FIELD_MODULE_NAME']->value == $_smarty_tpl->tpl_vars['SOURCE_MODULE']->value) && (!(preg_match("/\([A-Za-z_0-9]* \; \([A-Za-z_0-9]*\) [A-Za-z_0-9]*\)/",$_smarty_tpl->tpl_vars['FIELD_NAME']->value))) && $_smarty_tpl->tpl_vars['NUMBER_OF_COLUMNS_SELECTED']->value < $_smarty_tpl->tpl_vars['MAX_ALLOWED_COLUMNS']->value) {?>selected<?php $_smarty_tpl->_assignInScope('NUMBER_OF_COLUMNS_SELECTED', $_smarty_tpl->tpl_vars['NUMBER_OF_COLUMNS_SELECTED']->value+1);
}
}
ob_start();
echo vtranslate($_smarty_tpl->tpl_vars['FIELD_MODULE_NAME']->value,$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);
$_prefixVariable3 = ob_get_clean();
$_smarty_tpl->_assignInScope('WITH_MODULENAME', (("(").($_prefixVariable3)).(")-"));?>><?php echo Vtiger_Util_Helper::toSafeHTML(smarty_modifier_replace(vtranslate($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('label'),$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value),"-",$_smarty_tpl->tpl_vars['WITH_MODULENAME']->value));
...
$_smarty_tpl->_assignInScope('TRANS_GROUP_LABEL', $_prefixVariable4);?><optgroup label="<?php echo $_smarty_tpl->tpl_vars['TRANS_GROUP_LABEL']->value;?>
"><?php
