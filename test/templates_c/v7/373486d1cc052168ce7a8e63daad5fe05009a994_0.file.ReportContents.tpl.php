<?php
/* Smarty version 4.5.5, created on 2025-11-13 13:30:36
  from '/var/www/html/layouts/v7/modules/Reports/ReportContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_69155eec9cad37_35448885',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '373486d1cc052168ce7a8e63daad5fe05009a994' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Reports/ReportContents.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_69155eec9cad37_35448885 (Smarty_Internal_Template $_smarty_tpl) {
$_smarty_tpl->_checkPlugins(array(0=>array('file'=>'/var/www/html/vendor/smarty/smarty/libs/plugins/modifier.replace.php','function'=>'smarty_modifier_replace',),1=>array('file'=>'/var/www/html/vendor/smarty/smarty/libs/plugins/modifier.implode.php','function'=>'smarty_modifier_implode',),));
?>
...
$_smarty_tpl->_assignInScope('FIELD_LABEL', smarty_modifier_implode(" ",$_smarty_tpl->tpl_vars['FIELD_IMPLODE']->value));
...
$_smarty_tpl->_assignInScope('FIELD_EXPLODE_FIRST_UNDERBAR', explode('_',$_smarty_tpl->tpl_vars['FIELD']->value[2],2));
if (in_array($_smarty_tpl->tpl_vars['FIELD_EXPLODE_FIRST_UNDERBAR']->value[1],$_smarty_tpl->tpl_vars['INCLUDED_UNDERBAR_LABELS']->value)) {
$_smarty_tpl->_assignInScope('FIELD_EXPLODE', $_smarty_tpl->tpl_vars['FIELD_EXPLODE_FIRST_UNDERBAR']->value);
} else {
...
$_smarty_tpl->_assignInScope('FIRST_FIELD', vtranslate(trim($_smarty_tpl->tpl_vars['FIELDNAMES']->value[0]),$_smarty_tpl->tpl_vars['GROUPING_MODULES']->value[0]));
} elseif ($_smarty_tpl->tpl_vars['GROUPBYFIELDSCOUNT']->value == 2) {
$_smarty_tpl->_assignInScope('FIRST_FIELD', vtranslate(trim($_smarty_tpl->tpl_vars['FIELDNAMES']->value[0]),$_smarty_tpl->tpl_vars['GROUPING_MODULES']->value[0]));
$_smarty_tpl->_assignInScope('SECOND_FIELD', vtranslate(trim($_smarty_tpl->tpl_vars['FIELDNAMES']->value[1]),$_smarty_tpl->tpl_vars['GROUPING_MODULES']->value[1]));
} elseif ($_smarty_tpl->tpl_vars['GROUPBYFIELDSCOUNT']->value == 3) {
$_smarty_tpl->_assignInScope('FIRST_FIELD', vtranslate(trim($_smarty_tpl->tpl_vars['FIELDNAMES']->value[0]),$_smarty_tpl->tpl_vars['GROUPING_MODULES']->value[0]));
$_smarty_tpl->_assignInScope('SECOND_FIELD', vtranslate(trim($_smarty_tpl->tpl_vars['FIELDNAMES']->value[1]),$_smarty_tpl->tpl_vars['GROUPING_MODULES']->value[1]));
$_smarty_tpl->_assignInScope('THIRD_FIELD', vtranslate(trim($_smarty_tpl->tpl_vars['FIELDNAMES']->value[2]),$_smarty_tpl->tpl_vars['GROUPING_MODULES']->value[2]));
}
...
$_smarty_tpl->_assignInScope('FIRST_IS_HEAD', 0);
$_smarty_tpl->_assignInScope('SECOND_IS_HEAD', 0);?><tr><?php
...
if ($_smarty_tpl->tpl_vars['FIRST_VALUE']->value == " " || $_smarty_tpl->tpl_vars['VALUE']->value == "-") {?><td class="summaryHead"><?php echo $_smarty_tpl->tpl_vars['VALUE']->value;?>
</td><?php $_smarty_tpl->_assignInScope('FIRST_IS_HEAD', 1);
} elseif ($_smarty_tpl->tpl_vars['VALUE']->value == '') {?><td></td><?php } else { ?><td class="summary"><?php echo " ";?>
</td><?php }
...
if ($_smarty_tpl->tpl_vars['SECOND_VALUE']->value == " " || $_smarty_tpl->tpl_vars['VALUE']->value == "-" || $_smarty_tpl->tpl_vars['FIRST_IS_HEAD']->value == 1) {?><td class="summaryHead"><?php echo $_smarty_tpl->tpl_vars['VALUE']->value;?>
</td><?php $_smarty_tpl->_assignInScope('SECOND_IS_HEAD', 1);
} elseif ($_smarty_tpl->tpl_vars['VALUE']->value == '') {?><td></td><?php } else { ?><td class="summary"><?php echo " ";?>
</td><?php }
if ($_smarty_tpl->tpl_vars['VALUE']->value != " ") {
...
if ($_smarty_tpl->tpl_vars['THIRD_VALUE']->value == " " || $_smarty_tpl->tpl_vars['VALUE']->value == "-" || $_smarty_tpl->tpl_vars['SECOND_IS_HEAD']->value == 1) {?><td class="summaryHead"><?php echo $_smarty_tpl->tpl_vars['VALUE']->value;?>
</td><?php } elseif ($_smarty_tpl->tpl_vars['VALUE']->value == '') {?><td></td><?php } else { ?><td class="summary"><?php echo " ";?>
</td><?php }
if ($_smarty_tpl->tpl_vars['VALUE']->value != " ") {
$_smarty_tpl->_assignInScope('THIRD_VALUE', $_smarty_tpl->tpl_vars['VALUE']->value);
}
} else {
if ($_smarty_tpl->tpl_vars['NAME']->value == $_smarty_tpl->tpl_vars['FIRST_FIELD']->value || strstr($_smarty_tpl->tpl_vars['NAME']->value,$_smarty_tpl->tpl_vars['FIRST_FIELD']->value)) {?><td class="summaryHead"><?php echo $_smarty_tpl->tpl_vars['VALUE']->value;?>
</td><?php $_smarty_tpl->_assignInScope('FIRST_IS_HEAD', 1);
$_smarty_tpl->_assignInScope('FIRST_VALUE', $_smarty_tpl->tpl_vars['VALUE']->value);
} elseif ($_smarty_tpl->tpl_vars['NAME']->value == $_smarty_tpl->tpl_vars['SECOND_FIELD']->value || strstr($_smarty_tpl->tpl_vars['NAME']->value,$_smarty_tpl->tpl_vars['SECOND_FIELD']->value)) {?><td class="summaryHead"><?php echo $_smarty_tpl->tpl_vars['VALUE']->value;?>
</td><?php $_smarty_tpl->_assignInScope('SECOND_IS_HEAD', 1);
$_smarty_tpl->_assignInScope('SECOND_VALUE', $_smarty_tpl->tpl_vars['VALUE']->value);
} elseif ($_smarty_tpl->tpl_vars['NAME']->value == $_smarty_tpl->tpl_vars['THIRD_FIELD']->value || strstr($_smarty_tpl->tpl_vars['NAME']->value,$_smarty_tpl->tpl_vars['THIRD_FIELD']->value)) {?><td class="summaryHead"><?php echo $_smarty_tpl->tpl_vars['VALUE']->value;?>
</td><?php $_smarty_tpl->_assignInScope('THIRD_VALUE', $_smarty_tpl->tpl_vars['VALUE']->value);
