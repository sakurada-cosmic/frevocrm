...
/* Smarty version 4.5.5, created on 2025-11-13 13:29:29
  from '/var/www/html/layouts/v7/modules/Reports/step2.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_69155ea96931b0_86947271',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '9371b8df3cad847d93a179894dbedd40bcbe9217' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Reports/step2.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_69155ea96931b0_86947271 (Smarty_Internal_Template $_smarty_tpl) {
...
"><input type="hidden" name="joinColumn" value=<?php echo $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->getJoinColumn();?>
...
(<?php echo vtranslate('LBL_MAX',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 60)</label><select data-placeholder="<?php echo vtranslate('LBL_ADD_MORE_COLUMNS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div><?php if (!empty($_smarty_tpl->tpl_vars['SECONDARY_MODULES']->value)) {?><div class="form-group"><div class="row"><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['SECONDARY_MODULES']->value, 'SECONDARY_MODULE_NAME');
$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value) {
$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->do_else = false;
?><label class="col-lg-6"><?php echo vtranslate('LBL_RELATED_FIELD',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 : <?php echo vtranslate($_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value,$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value);?>
</label><?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></div><div class=""><?php $_smarty_tpl->_assignInScope('JOIN_COLUMN', explode(",",$_smarty_tpl->tpl_vars['REPORT_MODEL']->value->getJoinColumn()));
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['SECONDARY_MODULES']->value, 'SECONDARY_MODULE_NAME');
$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value) {
$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->do_else = false;
?><div class="col-lg-6"><select class="select2" name="joinfield_<?php echo $_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value;?>
"><option value=""><?php echo vtranslate("LBL_AUTO_SELECT",$_smarty_tpl->tpl_vars['MODULE']->value);
$_smarty_tpl->_assignInScope('RELATION_TABLES', $_smarty_tpl->tpl_vars['REPORT_MODEL']->value->getRelationTables($_smarty_tpl->tpl_vars['PRIMARY_MODULE_NAME']->value,$_smarty_tpl->tpl_vars['SECONDARY_MODULE_NAME']->value));
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['RELATION_TABLES']->value, 'JOIN_VALUE', false, 'JOIN_KEY');
$_smarty_tpl->tpl_vars['JOIN_VALUE']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['JOIN_KEY']->value => $_smarty_tpl->tpl_vars['JOIN_VALUE']->value) {
$_smarty_tpl->tpl_vars['JOIN_VALUE']->do_else = false;
$_smarty_tpl->_assignInScope('KEY_VALUE', explode("::",$_smarty_tpl->tpl_vars['JOIN_KEY']->value));
$_smarty_tpl->_assignInScope('JOIN_KEYNAME', ((string)$_smarty_tpl->tpl_vars['KEY_VALUE']->value[0])."::".((string)$_smarty_tpl->tpl_vars['KEY_VALUE']->value[1])."::".((string)$_smarty_tpl->tpl_vars['KEY_VALUE']->value[2]));
if ($_smarty_tpl->tpl_vars['KEY_VALUE']->value[2] == "default") {
continue 1;
}?><option value="<?php echo $_smarty_tpl->tpl_vars['JOIN_KEYNAME']->value;?>
" <?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['JOIN_COLUMN']->value, 'JOIN_COLUMN_VALUE', false, 'JOIN_COLUMN_KEY');
$_smarty_tpl->tpl_vars['JOIN_COLUMN_VALUE']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['JOIN_COLUMN_KEY']->value => $_smarty_tpl->tpl_vars['JOIN_COLUMN_VALUE']->value) {
$_smarty_tpl->tpl_vars['JOIN_COLUMN_VALUE']->do_else = false;
if ($_smarty_tpl->tpl_vars['JOIN_KEYNAME']->value == $_smarty_tpl->tpl_vars['JOIN_COLUMN_VALUE']->value) {?>selected<?php }
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>><?php echo vtranslate($_smarty_tpl->tpl_vars['KEY_VALUE']->value[3],$_smarty_tpl->tpl_vars['KEY_VALUE']->value[1]);
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div><?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></div></div><?php }?><div class="form-group"><div class="row"><label class="col-lg-6"><?php echo vtranslate('LBL_GROUP_BY',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
while ($_smarty_tpl->tpl_vars['SELECTED_SORT_FIELDS_COUNT']->value < 3) {?><div class="row sortFieldRow" style="padding:10px;"><?php $_smarty_tpl->_subTemplateRender(call_user_func_array($_smarty_tpl->registered_plugins[ 'modifier' ][ 'vtemplate_path' ][ 0 ], array( 'RelatedFields.tpl',$_smarty_tpl->tpl_vars['MODULE']->value )), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('ROW_VAL'=>$_smarty_tpl->tpl_vars['ROW_VAL']->value), 0, true);
