...
/* Smarty version 4.5.5, created on 2025-11-12 10:53:29
  from '/var/www/html/layouts/v7/modules/PDFTemplates/partials/EditViewContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_6913e8991c92a1_55879533',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '197f8cd8a39bcc8e7a962337e2290042be055ec1' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/PDFTemplates/partials/EditViewContents.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_6913e8991c92a1_55879533 (Smarty_Internal_Template $_smarty_tpl) {
...
' /><?php }?><div name='editContent'><div class='fieldBlockContainer'><span><h4 class='fieldBlockHeader' ><?php echo vtranslate('SINGLE_PDFTemplates',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"></td></tr><tr><td class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
 alignMiddle"><?php echo vtranslate('LBL_PDF_FILE_NAME',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td><td class="fieldValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"><input id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_editView_fieldName_pdffilename" type="text" class="inputElement" name="pdffilename" value="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('pdffilename');?>
"></td></tr><tr><td class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
</textarea></td></tr></tbody></table></div><div class='fieldBlockContainer'><span><h4 class='fieldBlockHeader'><?php echo vtranslate('LBL_PDF_TEMPLATE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"><?php echo vtranslate($_smarty_tpl->tpl_vars['GENERAL_FIELD']->value[0],$_smarty_tpl->tpl_vars['MODULE']->value);?>
</option><?php
}
...
"><?php echo vtranslate('LBL_CUSTOM_FUNCTIONS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td><td class="fieldValue <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
"><span class="col-sm-6 col-xs-6"><select class="inputElement select2 col-sm5 col-xs-5" id="customFunctions" name="customFunctions"><option value=""><?php echo vtranslate('LBL_NONE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</option><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['CUSTUM_FUNCTIONS']->value, 'CUSTUM_FUNCTION', false, 'index');
$_smarty_tpl->tpl_vars['CUSTUM_FUNCTION']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['index']->value => $_smarty_tpl->tpl_vars['CUSTUM_FUNCTION']->value) {
$_smarty_tpl->tpl_vars['CUSTUM_FUNCTION']->do_else = false;
?><option value="<?php echo $_smarty_tpl->tpl_vars['CUSTUM_FUNCTION']->value[1];?>
"><?php echo vtranslate($_smarty_tpl->tpl_vars['CUSTUM_FUNCTION']->value[0],$_smarty_tpl->tpl_vars['MODULE']->value);?>
</option><?php
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></span></td></tr><tr><td colspan="2" class="fieldLabel textAlignLeft"><?php echo vtranslate('LBL_BLOCK_MESSAGE',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</td></tr></tbody></table><div class="row padding-bottom1per"><?php $_smarty_tpl->_assignInScope('TEMPLATE_CONTENT', $_smarty_tpl->tpl_vars['RECORD']->value->get('body'));?><textarea id="templatecontent" name="templatecontent" <?php if ($_smarty_tpl->tpl_vars['IS_SYSTEM_TEMPLATE_EDIT']->value) {?> data-rule-required="true" <?php }?> ><?php if (!empty($_smarty_tpl->tpl_vars['TEMPLATE_CONTENT']->value)) {
