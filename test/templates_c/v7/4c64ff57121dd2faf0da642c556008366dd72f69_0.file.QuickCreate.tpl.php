...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_691447da5b3581_56871229',
...
function content_691447da5b3581_56871229 (Smarty_Internal_Template $_smarty_tpl) {
...
?><div class="modal-body pre-scrollable" <?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Events') {?>style="max-height:800px;"<?php }?>><?php if (!empty($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value)) {?><input type="hidden" name="picklistDependency" value='<?php echo Vtiger_Util_Helper::toSafeHTML($_smarty_tpl->tpl_vars['PICKIST_DEPENDENCY_DATASOURCE']->value);?>
...
?></div><div class="muted col-sm-2" style="line-height: 67px;left: 20px; padding-right: 7%;"><?php echo vtranslate('LBL_TO',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
$_smarty_tpl->_subTemplateRender(vtemplate_path($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getUITypeModel()->getTemplateName(),$_smarty_tpl->tpl_vars['MODULE']->value), $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, true);
?></div></div></div><div class="container-fluid paddingTop15 quickCreateContent"><table class="massEditTable table no-border"><tr><?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></tr><?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Events') {?><tr><td class="fieldLabel alignMiddle"><label class="muted"><?php echo vtranslate('LBL_INVITE_USERS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</label></td><td class="fieldValue"><select id="selectedUsers" class="select2 inputElement" multiple name="selectedusers[]"><?php
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></td><td></td><td></td></tr><?php }?></table></div></div></div><div class="modal-footer"><center><?php if ($_smarty_tpl->tpl_vars['BUTTON_NAME']->value != null) {
...
$_smarty_tpl->_assignInScope('EDIT_VIEW_URL', $_smarty_tpl->tpl_vars['CALENDAR_MODULE_MODEL']->value->getQuickCreateTaskRecordUrl());
if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Events') {
$_smarty_tpl->_assignInScope('EDIT_VIEW_URL', $_smarty_tpl->tpl_vars['CALENDAR_MODULE_MODEL']->value->getQuickCreateEventRecordUrl());
