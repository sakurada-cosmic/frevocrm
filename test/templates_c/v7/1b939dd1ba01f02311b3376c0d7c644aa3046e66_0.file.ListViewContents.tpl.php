...
/* Smarty version 4.5.5, created on 2025-11-07 12:56:52
  from '/var/www/html/layouts/v7/modules/Portal/ListViewContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d6e04c89cf1_27942576',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '1b939dd1ba01f02311b3376c0d7c644aa3046e66' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Portal/ListViewContents.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_690d6e04c89cf1_27942576 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
</a></center></div><div class="contents-topscroll noprint"><div class="topscroll-div">&nbsp;</div></div><div class="col-md-12 col-sm-12 col-xs-12 col-lg-12 listViewContentDiv" id="listViewContents"><div id="table-content" class="table-container"><?php $_smarty_tpl->_assignInScope('WIDTHTYPE', $_smarty_tpl->tpl_vars['CURRENT_USER_MODEL']->value->get('rowheight'));?><table id="listview-table" class="table listview-table portal-table"><thead><tr class="listViewContentHeader"><th class="table-bottom-border" nowrap="nowrap"><div class="table-actions" style="margin-left:0px !important;"><span class="input"><input class="listViewEntriesMainCheckBox" type="checkbox"></span></div></th><th class="table-bottom-border" nowrap="nowrap"><a href="#" class="listViewContentHeaderValues" data-nextsortorderval="<?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value == 'portalname') {
...
&nbsp;</a><?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value == 'portalname') {?><a href="#" class="removeSorting"><i class="fa fa-remove"></i></a><?php }?></th><th class="table-bottom-border" nowrap="nowrap"><a href="#" class="listViewContentHeaderValues" data-nextsortorderval="<?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value == 'portalurl') {
echo $_smarty_tpl->tpl_vars['NEXT_SORT_ORDER']->value;
...
&nbsp;</a><?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value == 'portalurl') {?><a href="#" class="removeSorting"><i class="fa fa-remove"></i></a><?php }?></th><th class="table-bottom-border" nowrap="nowrap"><a href="#" class="listViewContentHeaderValues" data-nextsortorderval="<?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value == 'createdtime') {
echo $_smarty_tpl->tpl_vars['NEXT_SORT_ORDER']->value;
