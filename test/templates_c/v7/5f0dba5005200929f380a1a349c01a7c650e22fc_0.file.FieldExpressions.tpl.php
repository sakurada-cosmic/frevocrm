<?php
/* Smarty version 4.5.5, created on 2025-11-12 17:29:44
  from '/var/www/html/layouts/v7/modules/Settings/Workflows/FieldExpressions.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_69144578ac6019_61127030',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5f0dba5005200929f380a1a349c01a7c650e22fc' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Settings/Workflows/FieldExpressions.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_69144578ac6019_61127030 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_smarty_tpl->tpl_vars['MODULE_FIELD']->value->getFieldDataType() == 'blank') {
continue 1;
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select></div><div class="col-sm-4 hide usePicklistContainer"><select id="usePicklist" class="usePicklist pull-right" data-placeholder="<?php echo vtranslate('LBL_USE_PICKLIST',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
" style="min-width: 160px;" type=""></select></div></div><br><div class="row fieldValueContainer"><div class="col-sm-12"><textarea data-textarea="true" class="fieldValue inputElement hide" style="height: inherit;"></textarea></div></div><br><div id="rawtext_help" class="alert alert-info helpmessagebox hide"><p><h5><?php echo vtranslate('LBL_RAW_TEXT',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
