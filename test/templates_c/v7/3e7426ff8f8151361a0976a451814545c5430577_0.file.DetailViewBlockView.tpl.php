...
/* Smarty version 4.5.5, created on 2025-11-13 13:39:06
  from '/var/www/html/layouts/v7/modules/Products/DetailViewBlockView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_691560ea8c0733_83835579',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '3e7426ff8f8151361a0976a451814545c5430577' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Products/DetailViewBlockView.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_691560ea8c0733_83835579 (Smarty_Internal_Template $_smarty_tpl) {
...
</h4></div><hr><div class="blockData"><table class="table detailview-table no-border"><tbody <?php if ($_smarty_tpl->tpl_vars['IS_HIDDEN']->value) {?> class="hide" <?php }?>><?php $_smarty_tpl->_assignInScope('COUNTER', 0);?><tr class="firstTr"><?php $_smarty_tpl->_assignInScope('IS_FIRST', true);
...
$_smarty_tpl->_assignInScope('IS_FIRST', false);?><td></td><td></td><td></td><td></td></tr><tr><?php }
...
if ($_smarty_tpl->tpl_vars['COUNTER']->value != 0) {?></tr><tr><?php $_smarty_tpl->_assignInScope('COUNTER', 0);
}?><td class="fieldLabel <?php echo $_smarty_tpl->tpl_vars['WIDTHTYPE']->value;?>
...
" colspan="3"><ul id="productsImageContainer"><?php
...
if (!empty($_smarty_tpl->tpl_vars['IMAGE_INFO']->value['url']) && !empty($_prefixVariable5)) {?><li><a href="<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['url'];?>
" target="_blank" alt="<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['orgname'];?>
" style="background-image: url(<?php echo $_smarty_tpl->tpl_vars['IMAGE_INFO']->value['url'];?>
)"></a></li><?php }
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></ul></td><?php $_smarty_tpl->_assignInScope('COUNTER', 2);
} elseif ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype') == "999") {
if ($_smarty_tpl->tpl_vars['COUNTER']->value == 2) {?></tr><tr><?php $_smarty_tpl->_assignInScope('COUNTER', 1);
} else {
$_smarty_tpl->_assignInScope('COUNTER', $_smarty_tpl->tpl_vars['COUNTER']->value+1);
}?><td class="blankField"></td><td class="blankField"></td><?php } else {
