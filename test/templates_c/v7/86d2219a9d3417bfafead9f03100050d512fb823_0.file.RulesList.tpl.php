<?php
/* Smarty version 4.5.5, created on 2025-11-07 14:46:21
  from '/var/www/html/layouts/v7/modules/Settings/MailConverter/RulesList.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d87ad3783a8_19016250',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '86d2219a9d3417bfafead9f03100050d512fb823' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Settings/MailConverter/RulesList.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_690d87ad3783a8_19016250 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
"<?php if (stripos($_smarty_tpl->tpl_vars['SCANNER_MODEL']->value->getCreateRuleRecordUrl(),'javascript:') === 0) {?>onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['SCANNER_MODEL']->value->getCreateRuleRecordUrl(), (int) strlen("javascript:"));?>
...
?><li><a <?php if (strpos($_smarty_tpl->tpl_vars['LINK']->value->getUrl(),'javascript:') === 0) {?> href='javascript:void(0);' onclick='<?php echo substr((string) $_smarty_tpl->tpl_vars['LINK']->value->getUrl(), (int) strlen("javascript:"));?>
