...
/* Smarty version 4.5.5, created on 2025-11-07 15:07:54
  from '/var/www/html/layouts/v7/modules/Inventory/partials/EditViewContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d8cba92dc24_41491398',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'abef94a1b598ee5000fcec758c68815074fe084e' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Inventory/partials/EditViewContents.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_690d8cba92dc24_41491398 (Smarty_Internal_Template $_smarty_tpl) {
...
$_smarty_tpl->_assignInScope('CHECK_CONTACTID', $_smarty_tpl->tpl_vars['CHECK_CONTACTID']->value);
...
</label></div><div class="radio<?php if ($_smarty_tpl->tpl_vars['CHECK_CONTACTID']->value == false) {?> hidden<?php }?>"><label><?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Quotes') {?><input type="radio" name="copyAddressFromRight" class="contactAddressWithoutLead" data-copy-address="billing" checked="checked">&nbsp;<?php echo vtranslate('Related To',$_smarty_tpl->tpl_vars['MODULE']->value);
...
</label></div><div class="radio<?php if ($_smarty_tpl->tpl_vars['CHECK_CONTACTID']->value == false) {?> hidden<?php }?>"><label><?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'Quotes') {?><input type="radio" name="copyAddressFromLeft" class="contactAddressWithoutLead" data-copy-address="shipping" checked="checked">&nbsp;<?php echo vtranslate('Related To',$_smarty_tpl->tpl_vars['MODULE']->value);
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->get('uitype') == "999") {?><td class="blankField"></td><td class="blankField"></td><?php continue 1;
