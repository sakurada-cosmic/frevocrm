<?php
/* Smarty version 4.5.5, created on 2025-11-07 10:48:05
  from '/var/www/html/layouts/v7/modules/Install/Step4.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d4fd536dbc9_58601665',
...
function content_690d4fd536dbc9_58601665 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
" name="db_name"></td>
							...
							<tr>
								<td colspan="2">
									<label>
										<input type="checkbox" name="create_db" <?php echo $_smarty_tpl->tpl_vars['IS_CREATE_NEW_DB']->value;?>
/>
							...
							<tr class="<?php if (empty($_smarty_tpl->tpl_vars['IS_CREATE_NEW_DB']->value)) {?>hide<?php } else {
}?>" id="root_user">
								<td><?php echo vtranslate('LBL_ROOT_USERNAME','Install');?>
<span class="no">*</span></td>
								<td><input type="text" value="<?php echo $_smarty_tpl->tpl_vars['DB_ROOT_USER']->value;?>
" name="db_root_username"></td>
							...
							<tr class="<?php if (empty($_smarty_tpl->tpl_vars['IS_CREATE_NEW_DB']->value)) {?>hide<?php } else {
								...
								<td><input type="password" value="<?php echo $_smarty_tpl->tpl_vars['DB_ROOT_PASSWORD']->value;?>
