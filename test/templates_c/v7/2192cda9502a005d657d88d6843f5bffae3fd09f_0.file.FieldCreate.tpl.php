<?php
/* Smarty version 4.5.5, created on 2025-11-07 11:03:31
  from '/var/www/html/layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d537347ef79_32964251',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '2192cda9502a005d657d88d6843f5bffae3fd09f' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Settings/LayoutEditor/FieldCreate.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_690d537347ef79_32964251 (Smarty_Internal_Template $_smarty_tpl) {
?>
...
"<?php if (($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataTypeLabel() == $_smarty_tpl->tpl_vars['FIELD_TYPE']->value || $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getFieldDataTypeLabel() == 'Relation')) {?>selected='selected'<?php }
...
</span></div></div></div><div class="form-group supportedType relationModules clearfix hide"><label class="control-label fieldLabel col-sm-5"><?php echo vtranslate('SELECT_MODULE',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['FIELD_TYPE_INFO']->value['Relation']['relationModules'], 'TRANS_RELATION_MODULE_NAME', false, 'RELATION_MODULE_NAME');
$_smarty_tpl->tpl_vars['TRANS_RELATION_MODULE_NAME']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['RELATION_MODULE_NAME']->value => $_smarty_tpl->tpl_vars['TRANS_RELATION_MODULE_NAME']->value) {
$_smarty_tpl->tpl_vars['TRANS_RELATION_MODULE_NAME']->do_else = false;
if ($_smarty_tpl->tpl_vars['RELATION_MODULE_NAME']->value != 'Calendar' && $_smarty_tpl->tpl_vars['RELATION_MODULE_NAME']->value != 'Events') {?> 											<option value="<?php echo $_smarty_tpl->tpl_vars['RELATION_MODULE_NAME']->value;?>
"><?php echo $_smarty_tpl->tpl_vars['TRANS_RELATION_MODULE_NAME']->value;?>
</option><?php }
}
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?></select><p class="related_field_caution"><?php echo vtranslate('Users','Vtiger');
echo vtranslate('LBL_CANT_SELECT_THE_OTHER_MODULE_WITH_USERS_FOR_RELFIELD','Vtiger');?>
</p></div></div><?php }
...
if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isActiveOptionDisabled()) {?> readonly="readonly" <?php }?> <?php if ($_smarty_tpl->tpl_vars['FIELD_MODEL']->value->isMandatory()) {?> readonly="readonly" <?php }?>data-on-text="<?php echo vtranslate('LBL_YES',$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
