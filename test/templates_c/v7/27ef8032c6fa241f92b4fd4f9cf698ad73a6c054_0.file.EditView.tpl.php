<?php
/* Smarty version 4.5.5, created on 2025-11-12 17:29:43
  from '/var/www/html/layouts/v7/modules/Settings/Workflows/EditView.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_69144577e72189_59452956',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '27ef8032c6fa241f92b4fd4f9cf698ad73a6c054' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Settings/Workflows/EditView.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_69144577e72189_59452956 (Smarty_Internal_Template $_smarty_tpl) {
...
<span class="redColor">*</span></label><div class="col-sm-5 controls"><input class="form-control" id="name" name="workflowname" value="<?php echo vtranslate($_smarty_tpl->tpl_vars['WORKFLOW_MODEL_OBJ']->value->workflowname,$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</label><div class="col-sm-5 controls"><textarea class="form-control" name="summary" id="summary"><?php echo vtranslate($_smarty_tpl->tpl_vars['WORKFLOW_MODEL']->value->get('summary'),$_smarty_tpl->tpl_vars['QUALIFIED_MODULE']->value);?>
...
</label><div class="col-sm-5 controls"><?php if ($_smarty_tpl->tpl_vars['MODE']->value == 'edit') {?><div class="pull-left"><?php if ($_smarty_tpl->tpl_vars['SELECTED_MODULE']->value == "Calendar" || $_smarty_tpl->tpl_vars['SELECTED_MODULE']->value == "Events") {
$_smarty_tpl->_assignInScope('SINGLE_SELECTED_MODULE', "SINGLE_".((string)$_smarty_tpl->tpl_vars['SELECTED_MODULE']->value));?><input type='text' disabled='disabled' class="inputElement" value="<?php echo vtranslate($_smarty_tpl->tpl_vars['SINGLE_SELECTED_MODULE']->value,$_smarty_tpl->tpl_vars['SELECTED_MODULE']->value);?>
" ><?php } else { ?><input type='text' disabled='disabled' class="inputElement" value="<?php echo vtranslate($_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getName(),$_smarty_tpl->tpl_vars['MODULE_MODEL']->value->getName());?>
" ><?php }?><input type='hidden' id="module_name" name='module_name' value="<?php echo $_smarty_tpl->tpl_vars['MODULE_MODEL']->value->get('name');?>
