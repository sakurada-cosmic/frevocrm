...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d62ea187b02_29371327',
...
function content_690d62ea187b02_29371327 (Smarty_Internal_Template $_smarty_tpl) {
...
" disabled="disabled"><i class="fa fa-comment"></i></button><?php }?><div class="btn-group listViewMassActions" role="group"><button type="button" class="btn btn-default btn-sm dropdown-toggle" data-toggle="dropdown"><?php echo vtranslate('LBL_MORE','Vtiger');?>
&nbsp;<span class="caret"></span></button><ul class="dropdown-menu" role="menu"><?php if (php7_count($_smarty_tpl->tpl_vars['LISTVIEW_MASSACTIONS_1']->value) > 0 || smarty_modifier_count($_smarty_tpl->tpl_vars['LISTVIEW_LINKS']->value['LISTVIEW']) > 0) {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);
}?><li><a id="resetColumnWidths" ><?php echo vtranslate('LBL_RESET_COLUMN_WIDTHS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
</a></li></ul></div></div></div><div class='col-md-6'><?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value == '0' && $_smarty_tpl->tpl_vars['REQUEST_INSTANCE']->value && $_smarty_tpl->tpl_vars['REQUEST_INSTANCE']->value->isAjax()) {
...
if ($_smarty_tpl->tpl_vars['CVNAME']->value != 'All') {?><div><?php echo vtranslate('LBL_DISPLAYING_RESULTS',$_smarty_tpl->tpl_vars['MODULE']->value);?>
 <?php echo vtranslate('LBL_UPDATE_FROM',$_smarty_tpl->tpl_vars['MODULE']->value);?>
