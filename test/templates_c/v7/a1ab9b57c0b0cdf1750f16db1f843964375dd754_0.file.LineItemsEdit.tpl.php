...
/* Smarty version 4.5.5, created on 2025-11-07 15:07:54
  from '/var/www/html/layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d8cba9cb215_24025127',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'a1ab9b57c0b0cdf1750f16db1f843964375dd754' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Inventory/partials/LineItemsEdit.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_690d8cba9cb215_24025127 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_smarty_tpl->tpl_vars['LINEITEM_FIELDS']->value['image']) {
...
' <?php if ($_smarty_tpl->tpl_vars['TAX_REGION_ID']->value == $_smarty_tpl->tpl_vars['RECORD']->value->get('region_id')) {?>selected<?php }?>><?php echo vtranslate($_smarty_tpl->tpl_vars['TAX_REGION_INFO']->value['name'],$_smarty_tpl->tpl_vars['MODULE']->value);?>
</option><?php
}
...
</strong></td><?php if ($_smarty_tpl->tpl_vars['IMAGE_EDITABLE']->value) {?><td><strong><?php ob_start();
...
if ($_smarty_tpl->tpl_vars['PRODUCT_EDITABLE']->value) {?><td><span class="redColor">*</span><strong><?php ob_start();
...
</strong></td><?php if ($_smarty_tpl->tpl_vars['PURCHASE_COST_EDITABLE']->value) {?><td><strong class="pull-right"><?php ob_start();
...
if ($_smarty_tpl->tpl_vars['LIST_PRICE_EDITABLE']->value) {?><td><strong><?php ob_start();
...
</strong></td><?php if ($_smarty_tpl->tpl_vars['MARGIN_EDITABLE']->value && $_smarty_tpl->tpl_vars['PURCHASE_COST_EDITABLE']->value) {?><td><strong class="pull-right"><?php ob_start();
...
} else { ?>0<?php }?></div></td></tr><?php if ($_smarty_tpl->tpl_vars['DISCOUNT_AMOUNT_EDITABLE']->value || $_smarty_tpl->tpl_vars['DISCOUNT_PERCENT_EDITABLE']->value) {?><tr id="overall_discount" valign="top" class="<?php if ($_smarty_tpl->tpl_vars['IS_INDIVIDUAL_TAX_TYPE']->value) {?>hide<?php }?>"><td width="83%"><span class="pull-right">(-)&nbsp;<strong><a href="javascript:void(0)" id="finalDiscount"><?php echo vtranslate('LBL_OVERALL_DISCOUNT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
"><?php echo vtranslate($_smarty_tpl->tpl_vars['CHARGE_MODEL']->value->getName());?>
...
?><tr><td class="lineOnTop"><?php echo vtranslate($_smarty_tpl->tpl_vars['tax_detail']->value['taxlabel'],$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
}?><td class="lineOnTop"><?php echo vtranslate($_smarty_tpl->tpl_vars['CHARGE_MODEL']->value->getName(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
 - <?php echo vtranslate($_smarty_tpl->tpl_vars['CHARGE_TAX_MODEL']->value->getName(),$_smarty_tpl->tpl_vars['MODULE']->value);?>
...
echo $_smarty_tpl->tpl_vars['FINAL']->value['shtax_totalamount'];
} else { ?>0<?php }?></span></td></tr><tr id="deduct_taxes" valign="top" class="<?php if ($_smarty_tpl->tpl_vars['IS_INDIVIDUAL_TAX_TYPE']->value) {?>hide<?php }?>"><td width="83%"><span class="pull-right">(-)&nbsp;<strong><a href="javascript:void(0)" id="deductTaxes"><?php echo vtranslate('LBL_DEDUCTED_TAXES',$_smarty_tpl->tpl_vars['MODULE']->value);?>
