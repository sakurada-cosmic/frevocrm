...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_6916d1bc2cc805_25490366',
...
function content_6916d1bc2cc805_25490366 (Smarty_Internal_Template $_smarty_tpl) {
...
_action_content"><div class="col-sm-6 col-xs-11 module-breadcrumb module-breadcrumb-<?php echo $_smarty_tpl->tpl_vars['REQ']->value['view'];?>
...
'>&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['CVNAME']->value);?>
&nbsp;</a> </p><?php }
...
">&nbsp;<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->get('label');?>
&nbsp;</a></p><?php }?></div><div class="col-sm-6 col-xs-1 pull-right"><div id="appnav" class="navbar-right"><ul class="nav navbar-nav"><?php
...
if ($_smarty_tpl->tpl_vars['BASIC_ACTION']->value->getLabel() == 'LBL_ADD_RECORD') {?><li><div><button type="button" class="btn btn-default module-buttons dropdown-toggle" data-toggle="dropdown" id="<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
_listView_basicAction_Add"><span class="fa fa-plus" title="<?php echo vtranslate('LBL_NEW_DOCUMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
"></span><span class="btn-str">&nbsp;&nbsp;<?php echo vtranslate('LBL_NEW_DOCUMENT',$_smarty_tpl->tpl_vars['MODULE']->value);?>
&nbsp;<span class="caret"></span></span></button><ul class="dropdown-menu dropdown-menu-right" id="add<?php echo $_smarty_tpl->tpl_vars['MODULE']->value;?>
DropdownMenu"><li class="dropdown-header"><i class="fa fa-upload"></i> <?php echo vtranslate('LBL_FILE_UPLOAD',$_smarty_tpl->tpl_vars['MODULE']->value);?>
