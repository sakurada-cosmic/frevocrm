...
/* Smarty version 4.5.5, created on 2025-11-07 14:43:10
  from '/var/www/html/layouts/v7/modules/Vtiger/RelatedActivities.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d86ee4606d4_82248013',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '135e06db8efcee05f9d63e400865744983984b8f' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Vtiger/RelatedActivities.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_690d86ee4606d4_82248013 (Smarty_Internal_Template $_smarty_tpl) {
...
'></span></div><div class='media-body col-lg-11 col-md-11 col-sm-11'><div class="summaryViewEntries"><?php if ($_smarty_tpl->tpl_vars['DETAILVIEW_PERMITTED']->value == 'yes') {?><a href="<?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getDetailViewUrl();?>
...
"></i></a><?php }?></div><?php $_smarty_tpl->_assignInScope('START_DATE_AND_TIME', Vtiger_Util_Helper::formatDateTimeIntoDayString(((string)$_smarty_tpl->tpl_vars['START_DATE']->value)." ".((string)$_smarty_tpl->tpl_vars['START_TIME']->value)));
$_smarty_tpl->_assignInScope('OWNER', $_smarty_tpl->tpl_vars['RECORD']->value->get('smownerid'));
$_smarty_tpl->_assignInScope('ACTIVITYTYPE', $_smarty_tpl->tpl_vars['RECORD']->value->get('activitytype'));
$_smarty_tpl->_assignInScope('DESCRIPTION', $_smarty_tpl->tpl_vars['RECORD']->value->get('description'));?><table><tr class="relatedActivitiesEntries"><td class="relatedActivitiesLabel"><?php echo vtranslate('Start Date & Time','Calendar');?>
</td><td class="relatedActivitiesValue"><?php echo $_smarty_tpl->tpl_vars['START_DATE_AND_TIME']->value;?>
</td></tr><tr class="relatedActivitiesEntries"><td class="relatedActivitiesLabel"><?php echo vtranslate('Assigned To');?>
</td><td class="relatedActivitiesValue"><?php echo getUserFullName($_smarty_tpl->tpl_vars['OWNER']->value);?>
</td></tr><tr class="relatedActivitiesEntries"><td class="relatedActivitiesLabel"><?php echo vtranslate('Activity Type','Calendar');?>
</td><td class="relatedActivitiesValue"><?php echo vtranslate($_smarty_tpl->tpl_vars['ACTIVITYTYPE']->value,$_smarty_tpl->tpl_vars['MODULE_NAME']->value);?>
</td></tr><tr class="relatedActivitiesEntries"><?php if ($_smarty_tpl->tpl_vars['ACTIVITYTYPE']->value == 'Emails') {?><td class="relatedActivitiesLabel" valign="top"><?php echo vtranslate('Description');?>
</td><td class="relatedActivitiesValue"><?php echo $_smarty_tpl->tpl_vars['RECORD']->value->getPlainTextDescription();?>
</td><?php } else { ?><td class="relatedActivitiesLabel" valign="top"><?php echo vtranslate('Description');?>
</td><td class="relatedActivitiesValue"><?php echo nl2br((string) $_smarty_tpl->tpl_vars['DESCRIPTION']->value, (bool) 1);?>
</td><?php }?></tr></table></div><div class='activityStatus pull-right' style='line-height: 0px;padding-right:30px;'><div class="row"><?php if ($_smarty_tpl->tpl_vars['RECORD']->value->get('activitytype') == 'Task') {
