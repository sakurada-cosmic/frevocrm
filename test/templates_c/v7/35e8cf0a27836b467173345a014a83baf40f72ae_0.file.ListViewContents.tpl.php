...
/* Smarty version 4.5.5, created on 2025-11-07 15:07:50
  from '/var/www/html/layouts/v7/modules/RecycleBin/ListViewContents.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d8cb62d58a1_15372960',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '35e8cf0a27836b467173345a014a83baf40f72ae' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/RecycleBin/ListViewContents.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_690d8cb62d58a1_15372960 (Smarty_Internal_Template $_smarty_tpl) {
...
?><div id="table-content" class="table-container"><form name='list' id='listedit' action='' onsubmit="return false;"><table id="listview-table" class="table <?php if ($_smarty_tpl->tpl_vars['LISTVIEW_ENTRIES_COUNT']->value == '0') {?>listview-table-norecords <?php } else { ?> listview-table<?php }?> "><thead><tr class="listViewContentHeader"><th class="none-border-bottom"><?php if (!$_smarty_tpl->tpl_vars['SEARCH_MODE_RESULTS']->value) {?><div class="table-actions"><span class="input"><input class="listViewEntriesMainCheckBox" type="checkbox"></span></div><?php } else {
...
?><th class="none-border-bottom" nowrap="nowrap"><a href="#" class="listViewContentHeaderValues" data-nextsortorderval="<?php if ($_smarty_tpl->tpl_vars['COLUMN_NAME']->value == $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('name')) {
...
"></i><?php } else { ?><i class="fa fa-sort customsort"></i><?php }?>&nbsp;<?php echo vtranslate($_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value->get('label'),$_smarty_tpl->tpl_vars['SOURCE_MODULE']->value);?>
...
</span></button><button type="button" class="searchAndClearButton btn btn-sm btn-danger <?php if (count($_smarty_tpl->tpl_vars['SEARCH_DETAILS']->value) == 0) {?>hide<?php }?>" data-trigger="clearListSearch"><i class="fa fa-close"></i>&nbsp;<?php echo vtranslate("LBL_CLEAR",$_smarty_tpl->tpl_vars['MODULE']->value);?>
</button></div></th><?php
$_from = $_smarty_tpl->smarty->ext->_foreach->init($_smarty_tpl, $_smarty_tpl->tpl_vars['LISTVIEW_HEADERS']->value, 'LISTVIEW_HEADER');
$_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->do_else = true;
if ($_from !== null) foreach ($_from as $_smarty_tpl->tpl_vars['LISTVIEW_HEADER']->value) {
...
echo count($_smarty_tpl->tpl_vars['LISTVIEW_HEADERS']->value);
