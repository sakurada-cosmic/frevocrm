...
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_6916d1bc30e112_72692450',
...
function content_6916d1bc30e112_72692450 (Smarty_Internal_Template $_smarty_tpl) {
...
if ($_prefixVariable6 > 40) {?> <?php echo htmlspecialchars((string)substr((string) $_smarty_tpl->tpl_vars['VIEWNAME']->value, (int) 0, (int) 40), ENT_QUOTES, 'UTF-8', true);?>
..<?php } else {
...
$_smarty_tpl->smarty->ext->_foreach->restore($_smarty_tpl, 1);?>
 ...
 ... </center></h6>
                    ...
                    <hr>
                    <div>
                        <input class="search-folders" type="text" placeholder="<?php echo vtranslate('LBL_SEARCH_FOR_FOLDER',$_smarty_tpl->tpl_vars['MODULE']->value);?>
">
                    </div>
           <div class="menu-scroller scrollContainer" style="position:relative; top:0; left:0;">                     
            <div class="list-menu-content">
...
$_smarty_tpl->_assignInScope('FOLDERNAME', $_prefixVariable7);?> 
                        <li style="font-size:12px;" class='documentFolder <?php if ($_smarty_tpl->tpl_vars['FOLDER_VALUE']->value == $_smarty_tpl->tpl_vars['FOLDER']->value->get('folderid')) {?> active<?php }?> <?php if ((isset($_smarty_tpl->tpl_vars['__smarty_foreach_folderView']->value['iteration']) ? $_smarty_tpl->tpl_vars['__smarty_foreach_folderView']->value['iteration'] : null) > 5) {?> filterHidden hide<?php }?>'>
...
">
                                <i class="fa <?php if ($_smarty_tpl->tpl_vars['FOLDER_VALUE']->value == $_smarty_tpl->tpl_vars['FOLDER']->value->get('folderid')) {?>fa-folder-open<?php } else { ?>fa-folder<?php }?>"></i> 
                                <span class="foldername"><?php echo htmlspecialchars((string)$_smarty_tpl->tpl_vars['FOLDERNAME']->value, ENT_QUOTES, 'UTF-8', true);?>
</span>
                            </a>
