...
/* Smarty version 4.5.5, created on 2025-11-07 14:43:11
  from '/var/www/html/layouts/v7/modules/Vtiger/uitypes/File.tpl' */

/* @var Smarty_Internal_Template $_smarty_tpl */
if ($_smarty_tpl->_decodeProperties($_smarty_tpl, array (
  'version' => '4.5.5',
  'unifunc' => 'content_690d86ef2f9cd7_52271446',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '5f647ba5a9eac772819ba83d75a04b65f0231fe0' => 
    array (
      0 => '/var/www/html/layouts/v7/modules/Vtiger/uitypes/File.tpl',
      1 => 1754376440,
      2 => 'file',
    ),
  ),
...
function content_690d86ef2f9cd7_52271446 (Smarty_Internal_Template $_smarty_tpl) {
...
" class="inputElement <?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'ModComments') {?> multi with-preview <?php }?> " maxlength="6" name="<?php if ($_smarty_tpl->tpl_vars['MODULE']->value == 'ModComments') {
...
"></span></span><div class="uploadedFileDetails <?php if ($_smarty_tpl->tpl_vars['IS_EXTERNAL_LOCATION_TYPE']->value) {?>hide<?php }?>"><div class="uploadedFileSize"></div><div class="uploadedFileName"><?php if (!empty($_smarty_tpl->tpl_vars['FIELD_VALUE']->value) && !$_smarty_tpl->tpl_vars['REQ']->value['isDuplicate']) {?>[<?php echo $_smarty_tpl->tpl_vars['FIELD_MODEL']->value->getDisplayValue($_smarty_tpl->tpl_vars['FIELD_VALUE']->value);?>
]<?php }?></div></div></div>
			<?php echo '<script'; ?>
>
